...
startup
{
	settings.Add("guesthouse", true, "Reached the Guest House");
	settings.Add("boltcutters", true, "Bolt Cutters");
	settings.Add("axe", true, "Axe (first time)");
	settings.Add("fuse", true, "Fuse (Guest House)");
	settings.Add("welcome2family", true, "Welcome to the family (splits during drag scene)");
	settings.Add("hatchkey", true, "Hatch Key");
	settings.Add("knife", true, "Knife");
	settings.Add("m19", true, "M19 (Guest House gun)");
	settings.Add("g17", true, "G17 (Garage gun)");
	settings.Add("carkey", true, "Car Key");
	settings.Add("oxstatue", true, "Ox Statuette");
	settings.Add("clockpendulum", true, "Clock Pendulum");
	settings.Add("bluedoghead", true, "Blue Dog Head");
	settings.Add("woodenstatue", true, "Wooden Statuette");
	settings.Add("whitedoghead", true, "White Dog Head");
	settings.Add("dissectionroomkey", true, "Dissection Room Key");
	settings.Add("reddoghead", true, "Red Dog Head");
	settings.Add("chainsaw", true, "Chainsaw");
	settings.Add("chainsawduel", true, "Finished chainsaw fight");
	settings.Add("scorpionkey", true, "Scorpion Key");
	settings.Add("trailer", true, "Reached the trailer (first time)");
	settings.Add("oldhouse", true, "Reached the Old House");
	settings.Add("burnergrip", true, "Burner Grip");
	settings.Add("burnernozzle", true, "Burner Nozzle");
	settings.Add("stonestatue", true, "Stone Statue");
	settings.Add("crank", true, "Crank");
	settings.Add("crowkey", true, "Crow Key");
	settings.Add("crowdoor", true, "Entered Crow Door (after falling down hole)");
	settings.Add("lantern", true, "Lantern");
	settings.Add("usedlantern", true, "Placed Lantern (to unlock door)");
	settings.Add("arm", true, "D-Series Arm");
	settings.Add("magnum", true, "Magnum");
	settings.Add("snakekey", true, "Snake Key");
	settings.Add("redkeycard", true, "Red Key Card");
	settings.Add("bluekeycard", true, "Blue Keycard");
	settings.Add("tvroom", true, "Reached Lucas TV room");
	settings.Add("battery", true, "Battery");
	settings.Add("candle", true, "Candle");
	settings.Add("valve", true, "Valve Handle");
	settings.Add("timebomb", true, "Timebomb");
	settings.Add("head", true, "D-Series Head");
	settings.Add("jacksback", true, "Completed Serum");
	settings.Add("hittheroadjack", true, "Injected Jack");
	settings.Add("boatcrash", true, "Mia Start");
	settings.Add("fuse2", true, "Fuse (ship)");
	settings.Add("videotape", true, "Mia Videotape (picked up)");
	settings.Add("videotapeend", true, "Mia Tape End");
	settings.Add("lugwrench", true, "Lug Wrench");
	settings.Add("powercable", true, "Power Cable");
	settings.Add("fuse3", true, "Retrieved Fuse (from door on ship)");
	settings.Add("miacomplete", true, "Mia Complete");
	settings.Add("necrotoxin", true, "Necrotoxin");
	settings.Add("injectedbitch", true, "Injected Evie");
	settings.Add("albert", true, "Albert Gun (Platimes over)");
	settings.Add("grenadelauncher", true, "Grenade Launcher");
}
